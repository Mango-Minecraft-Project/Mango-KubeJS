...
ServerEvents.recipes((event) => {
  ...
  tconstruct.alloy("tconstruct:molten_rose_gold", [
    Fluid.of("tconstruct:molten_gold", 1000),
    Fluid.of("tconstruct:molten_copper", 1000),
  ]);
  tconstruct.alloy(
...
ServerEvents.recipes((event) => {
  ...
  tconstruct
    .melting_fuel(200, Fluid.of("tconstruct:molten_gold", 1000))
    .temperature(1200);
  tconstruct
    .melting_fuel(200, Fluid.of("tconstruct:molten_gold", 1000))
    .rate(30);
...
ServerEvents.recipes((event) => {
  ...
  tconstruct
    .melting(Fluid.of("tconstruct:molten_gold", 1000), "minecraft:gold_ingot")
    .temperature(1200);
  tconstruct
    .melting(Fluid.of("tconstruct:molten_gold", 1000), "minecraft:gold_ingot")
    .time(200);
